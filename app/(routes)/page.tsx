			...
			<section className={styles.featured_section}>
				...
				<div className={styles.featured_artist_wrapper}>
					...
					<p className='regular-body'>
						...
						On January 19, 2015, he released his debut single &ldquo;Allure&rdquo;. On June 1, 2016, Faiyaz released
						&ldquo;Invite Me&rdquo;, the lead single from his upcoming debut EP. On September 19, 2016, his 21st
						birthday, the EP entitled A.M. Paradox was released and received with positive reviews from music critics.
						On January 26, 2017, Sonder released their debut EP Into.
					</p>
